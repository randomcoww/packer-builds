...
ExecStart=/usr/bin/docker run --rm --name ssh_gateway --net=docker1 --ip 172.20.0.2 -v /etc/resolv.conf:/etc/resolv.conf:ro randomcoww/ssh_gateway -u randomcoww -r https://github.com/randomcoww/ssh-gateway_user_config.git -b master
